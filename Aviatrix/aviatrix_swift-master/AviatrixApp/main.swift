...
func refuel(myPlane : Aviatrix) {
    ...
    print("⛽ You refueled \(plane.gallonsFilled) gallons totaling \(plane.refuelPrice)")
}
...
var plane = Aviatrix(name : "Bridget and Anum")

print("Welcome to the Aviatrix Flight System by \(plane.getAuthor())")
plane.start()

//plane.setLoc(newLoc:"St. Louis")

print("You're currently in \(plane.getLoc())")
...
print(" ")
print("Thanks for flying with Philly Phlossy Airlines!")
